...
<!-- End Sticky Share Group -->
        ...
        <div class="h-auto mt-16 md:mx-96 p-5">
          <div>
            <p class="text-3xl font-semibold dark:text-gray-50">Leave a Reply</p>
            ...
            <form class="space-y-4" @submit.prevent="handleSubmit">
              <div>
                ...
                <textarea
                  ...
                  class="mt-1 block w-full p-2 border border-gray-300 dark:bg-gray-200 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                ></textarea>
              </div>
              <div class="flex">
              ...
              <div>
                <button
                  type="submit"
                  class="w-56 flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  Post Comment
                </button>
              </div>
  ...
  export default {
    ...
    methods: {
      handleSubmit() {
        ...
        toast.success("Comment Posted successfully! You can comment again");
