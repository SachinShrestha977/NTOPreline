      ...
      <div class="flex items-center gap-x-4">
        ...
        <div class="grow">
          <h3 class="font-medium text-gray-800 dark:text-neutral-200">
            Mukunda Dev Adhikari</h3>
          <p class="text-xs uppercase text-gray-500 dark:text-neutral-500">
Fello Chartered Accountant          </p>
        </div>
      </div>

      <p class="mt-3 text-gray-500 dark:text-neutral-500">
        I am an ACA member of ICAEW, an international tax graduate
                  from CIOT, UK and FCA member of ICAN. I was partner in Baker
                  Tilly Nepal for eight years, and pioneered Nepal Tax Online
                  concept.      </p>
    ...
    <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-gray-900 dark:border-neutral-700">
      ...
      <p class="mt-3 text-gray-500 dark:text-neutral-500">
        I am a Fellow Chartered Accountant and renowned tax tutor in Nepal. While working as a partner in Baker Tilly in Nepal, I have gathered well experience and understanding of various sectors including development sector 
    </p>
...
Accountant          </p>
      ...
      <p class="mt-3 text-gray-500 dark:text-neutral-500">
        I have experience of over 10 years in Nepalese accounting
                  profession and tax, with exposures in accounting firms and
                  industries. I am leading the service team of Nepal Tax Online
                  since 2016.      </p>
    ...
    <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-gray-900 dark:border-neutral-700">
      ...
      <p class="mt-3 text-gray-500 dark:text-neutral-500">
        I am a renowned tax consultant and trainer in Nepal
                  and the author of the bestselling tax book titled, “Income Tax
                  and Value Added Tax.” I was felicitated by Nepal Government
                  in 2016 for his contribution to tax interpretation.       </p>
    ...
    <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-gray-900 dark:border-neutral-700">
      ...
      <p class="mt-3 text-gray-500 dark:text-neutral-500">
        I am an Attorney at Law and an Assistant Professor of Law
                  at Tribhuvan University, Nepal. I have advised high profile
                  clients on investment and corporate matters and appears in
                  large scales commercial litigation.      </p>
...
ICT Professional          </p>
      ...
      <p class="mt-3 text-gray-500 dark:text-neutral-500">
        I am an ICT professional with ten years of experience
                  using technology and tools to help organizations meet their
                  digital transformation goals.       </p>
