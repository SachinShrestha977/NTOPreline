      ...
      <div class="md:order-2 border-b border-neutral-800 pb-10 mb-10 md:border-b-0 md:pb-0 md:mb-0">
        <form>
          <div class="space-y-4">
            <!-- Input -->
            <div class="relative">
              <input type="text" id="hs-tac-input-name" class="peer p-4 block w-full  dark:bg-neutral-800 bg-gray-200 border-transparent rounded-lg text-sm dark:text-gray-400 placeholder:text-transparent focus:outline-none focus:ring-0 focus:border-transparent disabled:opacity-50 disabled:pointer-events-none
              focus:pt-6
              focus:pb-2
            ...
            <!-- Input -->
            <div class="relative">
              <input type="email" id="hs-tac-input-email" class="peer p-4 block w-full dark:bg-neutral-800 bg-gray-200 border-transparent rounded-lg text-sm dark:text-gray-400 placeholder:text-transparent focus:outline-none focus:ring-0 focus:border-transparent disabled:opacity-50 disabled:pointer-events-none
              focus:pt-6
              focus:pb-2
              [&:not(:placeholder-shown)]:pt-6
              [&:not(:placeholder-shown)]:pb-2
            ...
            <!-- Input -->
            <div class="relative">
              <input type="text" id="hs-tac-input-company" class="peer p-4 block w-full dark:bg-neutral-800 bg-gray-200 border-transparent rounded-lg text-sm dark:text-gray-400 placeholder:text-transparent focus:outline-none focus:ring-0 focus:border-transparent disabled:opacity-50 disabled:pointer-events-none
              focus:pt-6
              focus:pb-2
              [&:not(:placeholder-shown)]:pt-6
              [&:not(:placeholder-shown)]:pb-2
            ...
            <!-- Input -->
            <div class="relative">
              <input type="text" id="hs-tac-input-phone" class="peer p-4 block w-full dark:bg-neutral-800 bg-gray-200 border-transparent rounded-lg text-sm dark:text-gray-400 placeholder:text-transparent focus:outline-none focus:ring-0 focus:border-transparent disabled:opacity-50 disabled:pointer-events-none
              focus:pt-6
              focus:pb-2
              [&:not(:placeholder-shown)]:pt-6
              [&:not(:placeholder-shown)]:pb-2
            ...
            <!-- Textarea -->
            <div class="relative">
              <textarea id="hs-tac-message" class="peer p-4 block w-full dark:bg-neutral-800 bg-gray-200 border-transparent rounded-lg text-sm dark:text-gray-400 placeholder:text-transparent focus:outline-none focus:ring-0 focus:border-transparent disabled:opacity-50 disabled:pointer-events-none
              focus:pt-6
              focus:pb-2
              [&:not(:placeholder-shown)]:pt-6
              [&:not(:placeholder-shown)]:pb-2
          ...
          <div class="mt-2">
            ...
            <p class="mt-5">
              <a class="group inline-flex items-center gap-x-2 py-2 px-3 bg-base-orange font-medium text-sm text-gray-50 rounded-full focus:outline-none" href="#">
                Submit
      ...
      <div class="space-y-14">
        ...
        <!-- <div class="flex gap-x-5">
          ...
          <div class="grow">
            ...
            <p class="mt-2">
              <a class="group inline-flex items-center gap-x-2 font-medium text-sm text-base-orange decoration-2 hover:underline focus:outline-none focus:underline" href="#">
                Job openings
                <svg class="flex-shrink-0 size-4 transition group-hover:translate-x-0.5 group-hover:translate-x-0 group-focus:translate-x-0.5 group-focus:translate-x-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
              </a>
            </p>
